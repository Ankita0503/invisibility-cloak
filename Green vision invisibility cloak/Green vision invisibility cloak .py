...
cv2.createTrackbar("upper_hue", "bars", 80, 180, hello)  # Adjust these values for green color
cv2.createTrackbar("upper_saturation", "bars", 255, 255, hello)
cv2.createTrackbar("upper_value", "bars", 255, 255, hello)
cv2.createTrackbar("lower_hue", "bars", 40, 180, hello)  # Adjust these values for green color
